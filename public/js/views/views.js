              ...
              '{{#if IQ.FBUser}}',
                '<li class="dropdown">',
                  '<a class="dropdown-toggle" data-toggle="dropdown">',
                      '<img src="https://graph.facebook.com/557170381/picture?width=32&amp;height=32" width="18" height="18">',
                      '{{IQ.FBUser.name}}',
                  '</a>',
                  '<li {{action logout target="FB"}}><a>Logout</a></li>',
                '</li>',
              '{{else}}',
                '<li {{action login target="FB"}}><a>Login</a></li>',
              '{{/if}}',
            '</ul>',
        '</div><!-- /.nav-collapse -->',
      ].join('\n'))
